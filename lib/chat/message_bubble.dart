...
class MessageBubbleDM extends StatelessWidget {
  MessageBubbleDM(
    this.message,
    this.userName,
    this.userImage,
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          // color: isMe ? Kclr01 : Color(0xffFD0054),
          gradient: LinearGradient(
              end: isMe ? Alignment.topRight : Alignment.bottomLeft,
              begin: isMe ? Alignment.bottomLeft : Alignment.topRight,
              colors: isMe
                  ? [
                      Color(0xffd81b60),
                      Kclr01,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              textAlign: isMe ? TextAlign.right : TextAlign.left,
              style: TextStyle(
                color: isMe ? Color(0xffFD0054) : Colors.white,
